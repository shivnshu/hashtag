...
public class Quickaccess extends Activity {
	static int i=1;
	ListView l;
	UserDatabase db;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		l=(ListView)findViewById(R.id.quickaccesslistView1);
		db=new UserDatabase(this);
		String res=db.getAllfiles("quickaccess");	
	...
	private void fill(File[] dirs) {
		 ...
		 i++;
		 adapter = new customlistviewadapter(Quickaccess.this,t1,t2,t3,img);		 
		 ...
		 l.setOnItemLongClickListener(new OnItemLongClickListener() {
				...
				@TargetApi(Build.VERSION_CODES.HONEYCOMB) public boolean onItemLongClick(AdapterView<?> arg0, View arg1,
					...
					// TODO Auto-generated method stub
					PopupMenu p = new PopupMenu(Quickaccess.this, arg1);
					...
					p.setOnMenuItemClickListener(new OnMenuItemClickListener() {
						...
						public boolean onMenuItemClick(MenuItem arg0) {
							...
							if (arg0.getTitle().equals("Add a new tag")) {
								Intent i=new Intent(Quickaccess.this,TakeName.class);
								i.putExtra("file_path",path.get(arg2) );
								startActivity(i);							
							}
							if (arg0.getTitle().equals("Add an existing tag")) {
								Intent i=new Intent(Quickaccess.this,Addexistingtag.class);
								i.putExtra("file_path",path.get(arg2) );
								startActivity(i);	
							}
							if (arg0.getTitle().equals("Remove tags")) {
								Intent i=new Intent(Quickaccess.this,Removetags.class);
								i.putExtra("file_path",path.get(arg2) );
								startActivity(i);
							}
							if (arg0.getTitle().equals("View Related tags")) {
								Intent i=new Intent(Quickaccess.this,ShowRelatedTags.class);
								i.putExtra("file_path",path.get(arg2) );
								startActivity(i);
							}
							return false;
	...
	public boolean onCreateOptionsMenu(Menu menu) {
		...
		getMenuInflater().inflate(R.menu.quickaccess, menu);
		return true;
	}
